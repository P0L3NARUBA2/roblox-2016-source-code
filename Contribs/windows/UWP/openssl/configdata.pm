...
our %config = (
  ...
  build_infos => [ "build.info", "crypto\\build.info", "ssl\\build.info", "apps\\build.info", "test\\build.info", "util\\build.info", "tools\\build.info", "fuzz\\build.info", "crypto\\objects\\build.info", "crypto\\md4\\build.info", "crypto\\md5\\build.info", "crypto\\sha\\build.info", "crypto\\mdc2\\build.info", "crypto\\hmac\\build.info", "crypto\\ripemd\\build.info", "crypto\\whrlpool\\build.info", "crypto\\poly1305\\build.info", "crypto\\blake2\\build.info", "crypto\\des\\build.info", "crypto\\aes\\build.info", "crypto\\rc2\\build.info", "crypto\\rc4\\build.info", "crypto\\idea\\build.info", "crypto\\bf\\build.info", "crypto\\cast\\build.info", "crypto\\camellia\\build.info", "crypto\\seed\\build.info", "crypto\\chacha\\build.info", "crypto\\modes\\build.info", "crypto\\bn\\build.info", "crypto\\ec\\build.info", "crypto\\rsa\\build.info", "crypto\\dsa\\build.info", "crypto\\dh\\build.info", "crypto\\dso\\build.info", "crypto\\buffer\\build.info", "crypto\\bio\\build.info", "crypto\\stack\\build.info", "crypto\\lhash\\build.info", "crypto\\rand\\build.info", "crypto\\err\\build.info", "crypto\\evp\\build.info", "crypto\\asn1\\build.info", "crypto\\pem\\build.info", "crypto\\x509\\build.info", "crypto\\x509v3\\build.info", "crypto\\conf\\build.info", "crypto\\txt_db\\build.info", "crypto\\pkcs7\\build.info", "crypto\\pkcs12\\build.info", "crypto\\comp\\build.info", "crypto\\ocsp\\build.info", "crypto\\ui\\build.info", "crypto\\cms\\build.info", "crypto\\ts\\build.info", "crypto\\srp\\build.info", "crypto\\cmac\\build.info", "crypto\\ct\\build.info", "crypto\\async\\build.info", "crypto\\kdf\\build.info" ],
  build_type => "release",
  builddir => ".",
  cc => "cl",
  cflags => "",
  ...
  defines => [ "NDEBUG", "OPENSSL_THREADS", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_SYS_WINRT", "WINAPI_FAMILY=WINAPI_FAMILY_APP", "_WIN32_WINNT=0x0A00" ],
  ...
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_AFALGENG" ],
  openssl_sys_defines => [ "OPENSSL_SYS_WIN32" ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "-DOPENSSL_SYS_WINRT -DWINAPI_FAMILY=WINAPI_FAMILY_APP -D_WIN32_WINNT=0x0A00 --prefix=G:\\Newfolder\\roblox-2016-source-code\\Contribs\\windows\\UWP\\openssl\\build\\WINARM no-afalgeng no-asan no-asm no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-dso no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl => "C:\\Strawberry\\perl\\bin\\perl.exe",
  perlargv => [ "VC-WIN32", "no-shared", "no-asm", "no-dso", "no-engine", "no-capieng", "-DOPENSSL_SYS_WINRT", "-DWINAPI_FAMILY=WINAPI_FAMILY_APP", "-D_WIN32_WINNT=0x0A00", "--prefix=G:\\Newfolder\\roblox-2016-source-code\\Contribs\\windows\\UWP\\openssl\\build\\WINARM" ],
  prefix => "G:\\Newfolder\\roblox-2016-source-code\\Contribs\\windows\\UWP\\openssl\\build\\WINARM",
  processor => "",
  rc4_int => "unsigned int",
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "des", "aes", "rc2", "rc4", "idea", "bf", "cast", "camellia", "seed", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf" ],
  shared_ldflag => "",
  shlib_major => "1",
  shlib_minor => "1",
