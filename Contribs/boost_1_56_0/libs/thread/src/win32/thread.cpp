...
#define TLS_OUT_OF_INDEXES 0xFFFFFFFF
    ...
    namespace
    {
#if !defined(BOOST_HAS_THREADEX) || defined(RBX_PLATFORM_WIN_DURANGO)
// Windows CE and Durango don't define _beginthreadex
...
//          boost::throw_exception(thread_resource_error());
    ...
    {
        unsigned cores = 0;
#if !(defined(__MINGW32__) || defined (__MINGW64__)) && !defined(RBX_PLATFORM_WIN_DURANGO)
        DWORD size = 0;
...
#if !defined(UNDER_CE) && !defined(RBX_PLATFORM_WIN_DURANGO) && !defined(WINAPI_FAMILY_APP)
